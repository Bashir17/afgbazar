...
if(isset($_GET['delete'])){
  ...
  $db->query("UPDATE prodcuts SET deleted =1 WHERE id='$id'");
...
if(isset($_GET['add']) || isset($_GET['edit'])) {
		...
		if($_POST) {
			...
			if(!empty($_FILES)) {
				...
				$dbpath = '/afghanbazar/images/products/'.$uploadName;
				if($mimeType != 'image') {
...
<form class="form" action="products.php?<?php echo ((isset($_GET['edit']))?'edit='.$edit_id : 'add=1'); ?>" method="post" enctype="multipart/form-data">
	...
	<div class="form-group col-md-3">
		...
		<select class="form-control" name="brand" id="brand">
			...
			<option value="<?php echo $b['brand']; ?>"<?php echo (($brand == $b['id'])?' selected' : ''); ?>><?php echo $b['brand']; ?></option>
			<?php endwhile; ?>
		</select>
	</div>
	<div class="form-group col-md-3">
			...
			<div class="modal-body">
				<div class="container-fluid">
					...
					<div class="form-group col-md-2">
						<label for="qty<?php echo $i; ?>">Quantities:</label>
